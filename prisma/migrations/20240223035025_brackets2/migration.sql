/*
  ...
  - You are about to drop the column `bowlers` on the `Br_Design` table. All the data in the column will be lost.
  - Added the required column `players` to the `Br_Design` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Br_Design" DROP COLUMN "bowlers",
