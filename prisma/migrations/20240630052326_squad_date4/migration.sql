/*
  ...
  - Made the column `squad_date` on table `Squad` required. This step will fail if there are existing NULL values in that column.
...
ALTER COLUMN "squad_date" SET NOT NULL;
