/*
  ...
  - A unique constraint covering the columns `[div_id,start,games]` on the table `Eliminator` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Eliminator_div_id_start_games_key" ON "Eliminator"("div_id", "start", "games");
