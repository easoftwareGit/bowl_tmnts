/*
  ...
  - Added the required column `sort_order` to the `Feature` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Feature" ADD COLUMN     "sort_order" INTEGER NOT NULL,
