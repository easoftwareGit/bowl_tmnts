/*
  ...
  - The `squad_date` column on the `Squad` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
DROP COLUMN "squad_date",
ADD COLUMN     "squad_date" TIMESTAMP(3);
