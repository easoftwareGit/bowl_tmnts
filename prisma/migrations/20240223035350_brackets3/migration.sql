/*
  ...
  - Added the required column `start` to the `Br_Design` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Br_Design" ADD COLUMN     "start" INTEGER NOT NULL,
