/*
  ...
  - Added the required column `url` to the `Bowl` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Bowl" ADD COLUMN     "url" VARCHAR NOT NULL,
ALTER COLUMN "id" SET DEFAULT concat('bwl_', replace(cast(gen_random_uuid() as text), '-', ''));
