/*
  ...
  - A unique constraint covering the columns `[squad_id,lane_number]` on the table `Lanes` will be added. If there are existing duplicate values, this will fail.
...
ALTER COLUMN "squad_date" SET DATA TYPE TEXT;
...
-- CreateIndex
CREATE UNIQUE INDEX "Lanes_squad_id_lane_number_key" ON "Lanes"("squad_id", "lane_number");
