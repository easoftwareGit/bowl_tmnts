...
import {
  ...
  findTmntById,
  exportedForTesting,
} from "@/lib/db/tmnts/tmnts";
import { mockPrismaTmnts } from "../../../mocks/tmnts/mockTmnt";
...
// in @/lib/db/tmnts.ts, make sure to use correct prisma client
...
// in @/lib/db/tmnts.ts, make sure to use uncomment the
// exportedForTesting code at the bottom of this file
...
describe('tmnts', () => {
  ...
  describe('findTmntById()', () => {
    it('should find a tmnt by ID', async () => { 
