...
import { tmntPropsType, tmntType } from '@/lib/types/types';
...
describe('Save New Tmnt', () => {
  ...
  describe('render Tournament form', () => {   
    ...
    describe('render Events data', () => { 
      ...
      it('render events items after loaded Bowls', async () => { 
    ...
    describe('render Divisions data', () => {
      ...
      it('render divs items after loaded Bowls', async () => { 
        const user = userEvent.setup()
        render(<ReduxProvider><TmntDataForm tmntProps={tmntFormProps} /></ReduxProvider>)
        const loadingMessage = screen.getByText(/loading/i);
        expect(loadingMessage).toBeInTheDocument();
    ...
    describe('render Squads data', () => {
      ...
      it('render squad items after loaded Bowls', async () => {
        const user = userEvent.setup()
        render(<ReduxProvider><TmntDataForm tmntProps={tmntFormProps} /></ReduxProvider>)
        const loadingMessage = screen.getByText(/loading/i);
        expect(loadingMessage).toBeInTheDocument();
